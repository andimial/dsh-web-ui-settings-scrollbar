...
const NAV_LIST_SELECTOR = [
    '[role="dialog"][class*="_panel"] [class*="_navList"]',
    '[role="dialog"] [class*="_navList"]',
].join(',\n');
const NAV_SELECTOR = [
    '[role="dialog"][class*="_panel"] [class*="_nav"]',
...
function rules() {
    return [
        ...
        '',
        '/* flex-grow:1 是滚动必要条件：navList 在 nav（纵向 flex）内需',
        '   grow 占满可用高、min-height:0 允许收缩到低于内容高，内容超出',
        '   才触发 overflow-y 滚动 */',
        NAV_LIST_SELECTOR + ' {',
        '  flex: 1 1 auto;',
        '  min-height: 0;',
